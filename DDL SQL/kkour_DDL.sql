...
CONSTRAINT P_DOG_BIRTH_MONTH_CHK CHECK (DOG_BIRTH_MONTH BETWEEN 1 AND 12),
CONSTRAINT P_DOG_BIRTH_YEAR_CHK CHECK (DOG_BIRTH_YEAR BETWEEN 1980 AND 2030),
CONSTRAINT P_DOG_SEX_CHK CHECK (UPPER(SEX) IN ('M','F')) 
);
...
CONSTRAINT P_DOG_BREED_PERCENTAGE_FK FOREIGN KEY (DOG_ID) REFERENCES P_DOG (DOG_ID),
CONSTRAINT P_DOG_BREED_PERCENTAGE_FK1 FOREIGN KEY (BREED_ID) REFERENCES P_DOGBREED (BREED_ID),
CONSTRAINT P_DOG_BREED_PERCENTAGE_CHK CHECK (PERCENT BETWEEN 0 AND 100)
);
...
CONSTRAINT P_OWNER_EMAIL_CHK CHECK (EMAIL LIKE '%_@%_.%_')
);   
